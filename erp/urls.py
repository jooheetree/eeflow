...
from erp.views import voucher_list, nacct_list, payment_list, invoice_list, receipt_list, get_todo_count, voucher_list_group
...
urlpatterns = [
    ...
    path('voucher_list_group/', voucher_list_group, name='voucher_list_group'),  # 채무발생_group
]
